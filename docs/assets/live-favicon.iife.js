var LiveFavicon = (function (exports) {
  'use strict';
...
`);
  ...
  async function imageToCanvas(image, context) {
    ...
    const { canvas, context2d } = createCanvas$1(image.ownerDocument, context);
    const drawImage = () => {
      try {
  ...
  function createCanvas$1(ownerDocument, context) {
...
`;
  ...
  async function compressToPng(dataUrl, size) {
   ...
   */
  function initFavicon(interval = DEFAULT_INTERVAL, level = DEFAULT_LEVEL) {
  ...
  exports.initFavicon = initFavicon;

  return exports;

})({});
//# sourceMappingURL=live-favicon.iife.js.map
